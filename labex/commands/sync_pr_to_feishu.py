            ...
            try:
                ...
                if lab_path == None:
                    ...
                    if index_json == None:
                        ...
                        print(
                            f"→ [red]➜ SKIPPED:[/red] Multiple ({index_json}) index.json found in {pr_number}, comment to {pr_user}"
                        )
                        continue
                ...
                if issue_id == 0 and "noissue" not in pr_labels_list:
                    ...
                    self.github.comment_pr(repo_name, pr_number, comment)
                    print(
                        f"→ [red]➜ SKIPPED:[/red] No issue id found in {pr_number}, comment to {pr_user}"
                    )
                    continue
